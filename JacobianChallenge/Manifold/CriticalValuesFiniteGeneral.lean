...
noncomputable def criticalChartPullbackData_general
  ...
  have hF'ne_z0 : ¬ ∀ᶠ z in 𝓝 z₀, deriv F z = 0 :=
    JacobianChallenge.Manifold.deriv_not_eventually_zero_of_analyticAt_not_eventually_const
      hFA_at_x hFne
...
theorem criticalSet_finite_general
  ...
  JacobianChallenge.ContMDiff.Owed.degree.criticalSet_finite_of_chart_pullback
