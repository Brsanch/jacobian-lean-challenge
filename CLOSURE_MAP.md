...
**Final-state projection** (23/24 path): repo grows from current **117,113 LOC** → **~128,900–144,300 LOC** (adding the §F.3 11,800–27,200 LOC remaining range).
