...
- **Total `.lean`:** **~104,000 LOC** (combining the +2,948 LOC Hodge wave and the +2,280 LOC C3 reduction wave atop the 101,786 LOC post-Hodge-only baseline; precise total to be re-measured after both arcs land).
