...
## 🟢 ACTIVE ARC: Pompeiu kernel (committed 2026-05-24) — **Chip 3c-F + Chip 4 COMPLETE, Sub-chips 5.1 + 5.2 + 5.3{a,b,c} + 5.4{a,b,c-prep,c-final} LANDED**

Last rewrite: 2026-05-25 (Sub-chip 5.4c-final landed — manifold-side `∂̄` identity for `chartPompeiuSolution` with chart-transition factor; mirrors Chip 4's `partialZBarManifold_pompeiuKernelChart_eq_α_mul_transition` for the `chartPullbackZero`-fed Pompeiu kernel). Headlines —
